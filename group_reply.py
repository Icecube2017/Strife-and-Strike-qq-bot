...
async def init(api: BotAPI, message: GroupMessage, params):
    ...
    game.set_character('2410AB7265A435E36F39DC671B6D913A', '7758FDF03BDCD44055806E9245E4F264', '亭歆雨')
    game.set_character('2410AB7265A435E36F39DC671B6D913A', '9C74E4EEE32610EAF5DFEC1C1C968660', '云云子')
    ...
    game.set_skill('2410AB7265A435E36F39DC671B6D913A', '7758FDF03BDCD44055806E9245E4F264', '沉默')
    game.set_skill('2410AB7265A435E36F39DC671B6D913A', '9C74E4EEE32610EAF5DFEC1C1C968660', '嗜血')
    await api.post_group_message(group_openid=message.group_openid, content=_cnt, msg_id=message.id)
